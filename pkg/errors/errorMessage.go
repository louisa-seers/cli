...
var (
	...
	GALASA_ERROR_SUBMIT_MISSING_ACTION_FLAGS              = NewMessageType("GAL1009E: The submit command requires either test selection flags or a portfolio", 1009, STACK_TRACE_WANTED)
